...
public class SAMLConfig {
    ...
    public static final String TRANSFORM_TO_LOGIN = "saml2.transformToLogin";
    ...
    public void setTransformToLogin(String transformToLogin){
        pluginSettings.put(TRANSFORM_TO_LOGIN, transformToLogin);
    }
    ...
    public long getMaxAuthenticationAge() {
        ...
        return StringUtils.isBlank(value) ? 1209600 : Long.parseLong(value); // 2 weeks if not set
    }
    ...
    public String getTransformToLogin() {
        return (String) pluginSettings.get(TRANSFORM_TO_LOGIN);
    }

    public boolean getTransformToLoginFlag() {
        if (StringUtils.defaultString((String) pluginSettings.get(TRANSFORM_TO_LOGIN)).equals("true")) {
            return true;
        } else {
            return false;
        }
